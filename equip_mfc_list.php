...
<h1>Equipment and Manufacturers</h1>
<p>
    <a href="services.php" target="_self">
        <img src="images/manufacturers/becker.gif" alt="Authorized Becker Service Center" />
    </a>
    &nbsp;&nbsp;
    <a href="services.palatek.php" target="_self">
        <img src="images/manufacturers/sullivan-palatek.jpg" alt="Authorized Sullivan Palatek Service Center" />
    </a>
    &nbsp;&nbsp;
    <a href="http://www.almigusa.com/" target="_self">
...
<div>
    <h4>CONDENSATE REMOVAL SYSTEMS</h4>
    <ul>
        <li>ATLAS-COPCO</li>
        <li>BECKER</li>
        <li>BEKO</li>
...
<div>
    ...
    <ul>
        ...
        <li>CLARK</li>
        <li>COLEMAN</li>
        <li>COMPAIR KELLOGG</li>
        <li>COMPAIR LeROI</li>
        <li>CURTIS-TOLEDO</li>
        <li>DeVILBISS</li>
        <li>DIESEL PORTABLES</li>
        <li>ELLIOTT</li>
        <li>GARDNER-DENVER</li>
        <li>GRIMMER-SCHMIDT</li>
        <li>HYDROVANE</li>
        <li>INGERSOLL-RAND</li>
        <li>JOY</li>
        <li>KAESER</li>
